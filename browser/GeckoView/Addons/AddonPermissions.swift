    ...
    private static func formatURLAccessPermissions(
        ...
        if domainCount > maxShownPermissionsEntries {
            if domainCount - maxShownPermissionsEntries == 1 {
                localizedSiteAccessPermissions.append(forUpdate ? "Access your data on another domain." : "Access your data on another domain")
            } else {
                localizedSiteAccessPermissions.append(forUpdate ? "Access your data on other domains." : "Access your data on other domains")
            }
        }
        
        if siteCount > maxShownPermissionsEntries {
            if siteCount - maxShownPermissionsEntries == 1 {
                localizedSiteAccessPermissions.append(forUpdate ? "Access your data on another site." : "Access your data on another site")
            } else {
                localizedSiteAccessPermissions.append(forUpdate ? "Access your data on other sites." : "Access your data on other sites")
            }
        }
